<template>
  <FetchLoader :state="$fetchState" >
    <Container>
      <img class="bag" src="/homePage/front1.png"/>

      <PageHeader :title="title" :description="headerDescription" :isActive="true">
    ...
    <Container>
      ...
      <CrystallizeCatalogueItems :items="stackableContent"/>
